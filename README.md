...
## Video
The images were generated through the StyleGAN algorithm, as well as the Generative Engine by RunwayML (https://experiments.runwayml.com/generative_engine/). Additional manipulation to the images are done in Processing, with post-editing for further enhancements. For the video, a combination of sources - generated images, machine learnt images, Processing codes, humanoids from Synthesia (https://www.synthesia.io/), and additional post-editing were done.
